...
const SaveFormData = () => {
  ...
  return (
    <div className='w-screen  grid justify-center items-center bg-lightWhite '>
      <form className='lg:w-[850px] h-[416px] py-16 pl-20 grid  justify-start items-center bg-white border-x-[1px] border-b-[1px] border-borderColor'>
        <label htmlFor='name'>Full Name</label>
        <input
          className='p-2 rounded-md border-2 border-primary '
          type="text"
          name="name"
          required
          minLength={5}
